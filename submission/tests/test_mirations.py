...
def test_set_gov_notify_email(
    migration, email_action_payload, helpdesk_action_payload,
    ...
    submission_b = Submission.objects.create(**helpdesk_action_payload)
    ...
    assert post_submission_b.data == helpdesk_action_payload['data']
    assert post_submission_b.meta == helpdesk_action_payload['meta']
